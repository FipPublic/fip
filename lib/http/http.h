...
public:
	...
	bool responseBody(const char* bodyPtr, uint32 bodyLength, int statusCode, const std::map<std::string, std::string>& headers);
	...
	bool isReceived(void){ return m_isReceived; }
	void setIsReceived(void){ m_isReceived = true; }
protected:
